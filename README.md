...
* Web Interface Input Validation: In the current iteration of PANDA, most of the form input validation happens in the agent code, while the prescription is being processed. Moving more of this code to the front-end Javascript could give the user feedback if they entered a field incorrectly, improving the overall user experience.
